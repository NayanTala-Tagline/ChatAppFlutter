...
class GetAllPendingConnections {
  static Dio get _dio => Dio();
  static Future<ApiRepose> getAllPendingConnections(ConnectionBody body) async {
    try {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      String? accessToken = prefs.getString(StringValue.accessToken);
      var response = await _dio.post(AppConfig.getAllPendingConnectionsUrl,
          data: {
